      ...
      <Flex direction={"column"} m="20px">
          ...
          <Flex border="#ccc solid 1px" alignItems="center" rounded="md">
            ...
            <Flex direction={"column"}>
              ...
              <Flex alignItems={"center"}>
                <Text fontSize="12px">
                  {diffDays < 2 ? diffDays + " Night" : diffDays + " Nights"}
                </Text>
                <BsDot />
                <BsFillPersonFill fontSize={"12px"} />
                <Text fontSize="12px" ml={1}>
                  {totalGuest} {totalGuest < 2 ? "Guest" : "Guests"}{" "}
                </Text>
              </Flex>
            </Flex>
          </Flex>
        ...
        <Flex direction="column" mt="20px" mb="30px">
          <Flex justifyContent="space-between">
            ...
            <Text>
              {startDate == "" || startDate == null
                ? ""
                : format(new Date(startDate), "E MMM, dd yyyy")}
            </Text>
          </Flex>
          <Flex justifyContent="space-between">
            <Text>Check out</Text>
          ...
          <Flex justifyContent="space-between" mt={data.nominal ? "" : "20px"}>
            ...
            {data.nominal ? (
              <Text>
                {parseInt(data.nominal * diffDays).toLocaleString("ID", {
                  style: "currency",
                  currency: "IDR",
                })}
              </Text>
