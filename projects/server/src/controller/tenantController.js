  ...
  getTransaction: async (req, res) => {
    try {
      ...
      let data2 = await dbSequelize.query(
        `SELECT o.orderId, t.payProofImg, u.name as guestName, ty.name, t.status from transactions as t INNER JOIN users as u on t.userId = u.userId
            ...
            INNER JOIN properties as p on r.propertyId = p.propertyId INNER JOIN tenants as ten on p.tenantId = ten.tenantId where ten.tenantId = ${data0[0].tenantId} order by o.orderId desc limit 2;`,
